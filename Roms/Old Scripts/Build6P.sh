...
function show_menus() {
	...
	echo "         _____   _                 _____                                      ";
	echo "        (____ \ (_)      _        (____ \                                     ";
	echo "         _   \ \ _  ____| |_ _   _ _   \ \ ____ ____  ____  ___  ____   ___   ";
	echo "        | |   | | |/ ___|  _| | | | |   | / ___/ _  |/ _  |/ _ \|  _ \ /___)  ";
	echo "        | |__/ /| | |   | |_| |_| | |__/ | |  ( ( | ( ( | | |_| | | | |___ |  ";
	echo "        |_____/ |_|_|    \___\__  |_____/|_|   \_||_|\_|| |\___/|_| |_(___/   ";
	echo "                            (____/                  (_____|                   ";
	tput setaf 3
...
Configure(){
    ...
    echo "3. Setup Google Source"
    echo "4. Create ROM Directory" 
    echo "5. Initialize Repo"
    echo "6. Setup CCache"
    echo "7. Exit"
}
